...
def mock_data() -> Dataset:
    ...
    fake_data = torch.randn(NUM_MOCK_VIDEOS, NUM_MOCK_FRAMES, NUM_MOCK_CHANNELS, NUM_MOCK_HEIGHT, NUM_MOCK_WIDTH)
    
    # create 10 fake labels (random integers from 0 to 9)
    fake_labels = torch.randint(0, NUM_MOCK_VIDEOS, (NUM_MOCK_VIDEOS,))
    ...
    dataset.glosses = [str(i) for i in range(NUM_MOCK_VIDEOS)]
